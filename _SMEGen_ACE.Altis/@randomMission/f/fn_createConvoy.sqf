...
_convoyObj =
[
	[( "EMPTY_TRUCK" call T8RMG_fnc_getVehicleClass ),[2.78223,-5.03442,0.0148301],359.746,1,0,[-1.46491,-1.97464],"","",true,false], 
	[( "EMPTY_TRUCK" call T8RMG_fnc_getVehicleClass ),[3.21216,6.7041,0.0133648],14.028,1,0,[-1.46265,2.16254],"","",true,false], 
	[( "EMPTY_TRUCK_FUEL" call T8RMG_fnc_getVehicleClass ),[2.85547,-12.8306,-0.0207224],8.61804,1,0,[-0.723469,0.00459397],"","",true,false], 
	...
	[( "EMPTY_OFFROAD_A" call T8RMG_fnc_getVehicleClass ),[0.455811,16.5078,-0.0298858],314.806,1,0,[-0.483479,-0.062224],"","",true,false], 
	[( "EMPTY_OFFROAD_A" call T8RMG_fnc_getVehicleClass ),[0.279053,-23.8953,-0.030436],144.135,1,0,[-0.479337,-0.114638],"","",true,false]
];
