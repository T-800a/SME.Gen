...
class Params
{
	...
	class param_reward
	{
		...
		texts[]		= { "BLUFOR", "BLUFOR - ACE",	"CUP USMC",	"RHS Independent",	"Vanilla full Arsenal",	"CUP USMC full Arsenal",	"RHS Independent full Arsenal",	"DEFAULT - CUP USMC full Arsenal" };
		default		= 999;
	};
