...
class T8L_DataDownloadDialog 
{
	idd = -1;
	movingEnable = true; 
	enableSimulation = true; 	
	onUnload = "call T8L_fnc_abortActionLaptop";
	
	controlsBackground[] = { MainBackground, T8L_DDD_closeText, T8L_DDD_head, T8L_DDD_line01L, T8L_DDD_line01R, T8L_DDD_line02L, T8L_DDD_line02R }; 	
	objects[] = { }; 
	controls[] = { T8L_DDD_close };
