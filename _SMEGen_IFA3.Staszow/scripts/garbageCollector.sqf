...
T8G_var_timeWeaponHolder		= 600;		// weapon holder are deleted after XX sec.
T8G_var_timeDeadBody			= 600;		// dead bodies are deleted after XX sec.
T8G_var_timeGraveStone			= 120;		// grave stones are deleted after XX sec.
T8G_var_deleteEmptyGroup		= false;	// empty groups are deleted
T8G_var_deleteEmptyDetector		= true;		// empty/dead triggers are deleted
