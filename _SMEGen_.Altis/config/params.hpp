...
class Params
{
	...
	class param_enemy
	{
		...
		texts[]		= { "CSAT", "CSAT Urban", "CSAT Guerilla", "AAF", "AAF - Guerilla", "CUP - Takistan Army",	"CUP - Takistan Locals",	"CUP - NAPA",	"RHS EAST militia",	"DEFAUL - CSAT Urban" };
		default		= 999;
	};
	...
	class param_reward
	{
		...
		texts[]		= { "BLUFOR", "BLUFOR - ACE",	"CUP USMC",	"RHS Independent",	"Vanilla full Arsenal",	"CUP USMC full Arsenal",	"RHS Independent full Arsenal",	"DEFAULT - Vanilla full Arsenal" };
		default		= 999;
	};
