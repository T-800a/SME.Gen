...
if ( isnil "T8U_fnc_combatBehaviorMod" ) then {			T8U_fnc_combatBehaviorMod = compile preProcessFileLineNumbers			( T8U_dir_ROOT + T8U_dir_FNCS + "fn_combatBehaviorMod.sqf" ); };
...
if ( isnil "T8U_fnc_createWaypoint" ) then {			T8U_fnc_createWaypoint = compile preProcessFileLineNumbers				( T8U_dir_ROOT + T8U_dir_FNCS + "fn_createWaypoint.sqf" ); };
...
if ( isnil "T8U_fnc_FindOverwatch" ) then {				T8U_fnc_FindOverwatch = compile preProcessFileLineNumbers				( T8U_dir_ROOT + T8U_dir_FNCS + "fn_findOverwatch.sqf" ); };
...
if ( isnil "T8U_fnc_forceNextWaypoint" ) then {			T8U_fnc_forceNextWaypoint = compile preProcessFileLineNumbers			( T8U_dir_ROOT + T8U_dir_FNCS + "fn_forceNextWaypoint.sqf" ); };
...
if ( isnil "T8U_fnc_groupClearWaypoints" ) then {		T8U_fnc_groupClearWaypoints = compile preProcessFileLineNumbers			( T8U_dir_ROOT + T8U_dir_FNCS + "fn_groupClearWaypoints.sqf" ); };
...
if ( isnil "T8U_fnc_InBuilding" ) then {				T8U_fnc_InBuilding = compile preProcessFileLineNumbers					( T8U_dir_ROOT + T8U_dir_FNCS + "fn_inBuilding.sqf" ); };
...
if ( isnil "T8U_supp_supportHALO" ) then {				T8U_supp_supportHALO = compile preProcessFileLineNumbers				( T8U_dir_ROOT + T8U_dir_SUPP + "supportHALO.sqf" ); };
