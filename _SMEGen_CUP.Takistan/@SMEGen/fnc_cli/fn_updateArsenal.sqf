...
private [ "_itemSet" ];
params [[ "_rank", T8SME_server_var_playerRewardSet, [""]]];
...
_backpackCargo	= getArray ( missionConfigFile >> "cfgRandomMissions" >> "missionPlayerRewards" >> T8SME_server_var_playerRewardSet >> _itemSet >> "BackpackReward" );
_itemCargo		= getArray ( missionConfigFile >> "cfgRandomMissions" >> "missionPlayerRewards" >> T8SME_server_var_playerRewardSet >> _itemSet >> "ItemReward" );
_magazineCargo	= getArray ( missionConfigFile >> "cfgRandomMissions" >> "missionPlayerRewards" >> T8SME_server_var_playerRewardSet >> _itemSet >> "MagazineReward" );
_weaponCargo	= getArray ( missionConfigFile >> "cfgRandomMissions" >> "missionPlayerRewards" >> T8SME_server_var_playerRewardSet >> _itemSet >> "WeaponReward" );

__DEBUG( __FILE__,"T8SME_server_var_playerRewardSet", T8SME_server_var_playerRewardSet );
